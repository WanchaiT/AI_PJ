...
model.add(Conv2D(50, kernel_size=(2, 2), activation='relu', input_shape=(20, 130, 1)))
...
model.fit(X_train, y_train_hot, batch_size=100, epochs=500, verbose=1, validation_data=(X_test, y_test_hot))
print("y_train = ")
print(y_train)
